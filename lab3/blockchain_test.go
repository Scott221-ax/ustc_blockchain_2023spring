...
func TestMineBlock(t *testing.T) {
	...
	assert.Equal(t, int64(1), block.Header.Version, "1mine block fail!")
	...
	assert.Equal(t, mk, block.Header.MerkleRoot, "2mine block fail!")
	assert.Equal(t, bc.tip, block.CalCulHash(), "3mine block fail!")
